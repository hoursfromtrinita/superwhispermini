...
export function LGWaveAndSpinner() {
  ...
  return (
    <div className="relative h-[42px] flex items-center justify-center">
      <motion.div
        ...
        animate={{
          width: isResting ? 24 : isListeningOrProcessing ? 100 : textWidth + 48,
          height: isResting ? 24 : isListeningOrProcessing ? 32 : 36,
        ...
        <AnimatePresence mode="wait">
          {state === 'listening' ? (
            ...
            <motion.span 
              ...
              className={clsx(
                "whitespace-nowrap",
                isListeningOrProcessing && "text-[#f7f7f7] font-medium"
              )}
              initial={{ 
                scale: 0.8, 
                opacity: 0 
